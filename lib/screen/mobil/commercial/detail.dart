...
class DetailCommercial extends StatefulWidget {
  const DetailCommercial({super.key});

  @override
  State<DetailCommercial> createState() => _DetailCommercial();
}

class _DetailCommercial extends State<DetailCommercial> {
  @override
